...
function runBaseTests() {
  og_gis_map_1 = document.getElementById('og_gis_map_1');

  suite('Base Automation Tests for og-gis-map', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-gis-map fixture is created', function() {
      assert.isTrue(document.getElementById('og_gis_map_1') !== null);
    });
